...
{
    public class ColleagueDiscountAppliacation : IColleagueDiscountApplication
    {
        private readonly IColleagueDiscountRepository _colleagueDiscountRepository;
        public ColleagueDiscountAppliacation(IColleagueDiscountRepository colleagueDiscountRepository)
        {
